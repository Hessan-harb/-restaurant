	...
	@include('admin.navbar')
		...
		<div class="page-wrapper">
            ...
            <div class="page-content row justify-content-center">
                ...
                mb-n3 font-bold text-2xl d-inline-block">Food Update</label>
                <div style="position: relative;  right:-150px;">
                <form action="{{url('/updatefood',$data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div>
                            <label for="">Title: </label>
                            <input class="rounded-3 text-gray-700" type="text" name="title" value="{{$data->title}}">
                        </div><br>

                        <div>
                            <label for="">Price: </label>
                            <input class="rounded-3 text-gray-700" type="number" name="price" value="{{$data->price}}">
                        </div><br>
                        ...
                        <div>
                            ...
                            <input class="rounded-3 text-gray-700" type="text" name="description" value="{{$data->description}}">
                        </div><br>
